...
If you have not yet run Playwright in CI, start with [`Playwright-Onboarding-Lab`](https://github.com/bg-playground/Playwright-Onboarding-Lab). Then come back here for the ideas that prevent fragile habits from forming:
...
If CI is not green yet, use [`Playwright-Onboarding-Lab`](https://github.com/bg-playground/Playwright-Onboarding-Lab) first. Then:
